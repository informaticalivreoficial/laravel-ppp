            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" placeholder="Nome do Perfil" value="{{ old('name') ?? $profile->name  }}">
                        </div>
                    </div>
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                ...
                <div class="row">                            
                    <div class="col-12">   
                        ...
                        <x-adminlte-text-editor name="content" v placeholder="Descrição do plano..." :config="$config">{{ old('content') ?? $profile->content }}</x-adminlte-text-editor>                                                      
                    </div>
                </div>
                </form>
            </div> 
