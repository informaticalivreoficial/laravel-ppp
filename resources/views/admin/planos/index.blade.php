                ...
                <tbody>
                    ...
                    <tr style="{{ ($plano->status == '1' ? '' : 'background: #fffed8 !important;')  }}">                            
                        ...
                        <td>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Permissões" href="{{ route('planos.perfis', $plano->id ) }}" class="btn btn-xs btn-primary"><i class="fas fa-address-book"></i></a>
